<?php 
    /**
     * -> Afficher toute les données sous forme de badge
     * -> Afficher une statisque des données (again)(coubes, tableaux,...)
     * 
     */
?>
                    ...
                    <div class="row text-center table-responsive">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="info-box bg-red hover-zoom-effect">
                                ...
                                <div class="content">
                                    <div class="text"> PROPRIETAIRES </div>
                                    <div class="number"> 10 </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Pour afficher le nombre de loc/batiments -->
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="info-box bg-yellow hover-zoom-effect">
                                <div class="icon">
                                    <i class="material-icons">person</i>
                                ...
                                <div class="content">
                                    <div class="text"> BAT 1 </div>
                                    <div> <span class="number"> 10 </span> Locataires </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
