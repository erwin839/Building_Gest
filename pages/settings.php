<?php
     ...
     *  -> Delete a manager
     *  -> Change color of the theme (Possiblity to set Dark Mode)
     *  -> Change fonts (Les polices)
     *  -> List of managers
     *  -> When clic on a manager (Liste déroulante)
    */
                        ...
                        <div class="body">
                            <div>
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Paramètes simples</a></li>
                                    <li role="presentation"><a href="#profile_settings" aria-controls="settings" role="tab" data-toggle="tab">Paramètes avancés</a></li>
                                            ...
                                            <div class="panel-heading">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            <!-- 
                                                                Afficher ici (Home) les differentees informations
                                                                du manager 
                                                             -->
                                                            <img src="public/Ui_Template/images/user-lg.jpg" />
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="post">
                                                    ...
                                                    <div class="post-content">
                                                        <img src="public/Ui_Template/images/profile-post-image.jpg" class="img-responsive" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="profile_settings">
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="Name" name="nom" placeholder="Nom" value="Marc K. Hammond" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="lastName" name="prenom" placeholder="Prenom" value="Marc K. Hammond" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="adress" name="adresse" placeholder="Adresse" value="Polel Diaoublé" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="date" class="form-control" id="birth" name="naissance" placeholder="08/09/12" value="" required>
                                                    </div>
                                                </div>
                                            </div> -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    ...
                                                    <label for="terms_condition_check">J'accepte les <a href="#">termes et conditions</a></label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <button type=""  class="btn btn-danger" id="btn_valider" onclick="test()">VALIDER</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
