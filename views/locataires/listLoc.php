            ...
            <div class="body">
                <div class="border border-light p-3 mb-4">
                    ...
                    <div class="text-right">
                        <button type="button" class="btn btn-primary locataire button-waves-float waves-light" data-toggle="modal" data-target="#modalInfos" id="affichModal"> Ajouter </button>
                    </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control show-tick" data-live-search="false" id="nomBatiment" name="nomBatiment">
                                                        <option disabled selected> Batiment </option>
                                                        <?php foreach ($batiments as $bat) : ?>
                                                            <option value=" <?= $bat['idBat'] ?> "> <?= $bat['nomBat'] .' - '. $bat['emplacement'] ?> </option>
                                                        <?php endforeach ?>
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control show-tick" data-live-search="true" id="numAppart" name="numAppart">
                                                        <option disabled selected> Appartement </option>
                                                        <?php foreach ($appartements as $appart) : ?>
                                                            <option value=" <?= $appart['idAppart'] ?> "> <?= $appart['codeAppart'] ?> </option>
                                                        <?php endforeach ?>
                                                    </select>
                                                    <div class="form-inline" id="apppartError"> cqscsc </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row clearfix">
