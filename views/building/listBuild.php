                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control show-tick" data-live-search="false" name="idPro" id="proprietaire">
                                                    <option disabled selected> Proprietaire </option>
                                                    <?php foreach ($proprios as $pro) : ?>
                                                        <option value=" <?= $pro['idP'] ?> "> <?= $pro['nomP'] .' - '. $pro['prenomP'] ?> </option>
                                                    <?php endforeach ?>
                                                </select>
                                                </div>
                                            </div>
